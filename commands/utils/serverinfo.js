...
module.exports.run = async (client, message, args) => {
    ...
    var memberCounts = message.guild.memberCount;

    var voicetext = '#️⃣ ' + ' ' + textChannelCount + ' ' + 'Text ' + ', ' + ' ' + ' ' + ' 🔊 ' + voiceChannelCount + ' ' + 'Voice';
    var serverMembers = `${memberCounts}` + ' ' + '**Total** Members' + ', ' + `${message.guild.members.cache.filter(member => member.user.bot).size}` + ' ' + '**Bot(s)**';
