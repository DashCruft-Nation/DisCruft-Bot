...
exports.run = (client, message, args) => {
  ...
  if (message.mentions.users.first().id === "633730629560958976") return message.reply("You can't ban my Developer:wink:");
  ...
  .setFooter(`© Dashcruft by ${customisation.ownername}`);
